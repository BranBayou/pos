...
import AddItem from '../Popups/AddItem.vue'
...
<template>
    <div>
        <button @click="authStore.toggleAddItemPopup" class="border shadow-lg w-full text-center p-5 rounded-2xl flex gap-5 my-5">
