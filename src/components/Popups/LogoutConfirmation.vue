...
<template>
    <Teleport to="body">
      <Transition name="modal-outer">
        <div v-show="authStore.isLogoutConfirmationVisible" class="absolute w-full bg-black bg-opacity-30 h-screen top-0 left-0 flex justify-center px-8">
          <Transition name="modal-inner" class="rounded-2xl">
            <div v-if="authStore.isLogoutConfirmationVisible" class="fixed top-44 z-50 flex items-center justify-center bg-black bg-opacity-50">
